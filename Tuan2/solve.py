...
# Move stores (m, y, side) i.e number of missionaries,
...
class Solution():
    def __init__(self):
        ...
        self.graph = pydot.Dot(graph_type='graph', bgcolor="#fff3a3", 
    ...
    def draw_legend(self):
        ...
        \ncannibals to be moved from left to right or c = 1 and viceversa"
